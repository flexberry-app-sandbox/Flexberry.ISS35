...
namespace IIS.ISS35
{
    ...
    public class Support : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS35.Form fForm;
        
        private IIS.ISS35.DetailArrayOfListIndustry fListIndustry;
        
        private IIS.ISS35.DetailArrayOfListInv fListInv;
        
        private IIS.ISS35.DetailArrayOfListSize fListSize;
        ...
        [NotNull()]
        public virtual IIS.ISS35.Form Form
        {
            get
            {
                ...
                IIS.ISS35.Form result = this.fForm;
        ...
        public virtual IIS.ISS35.DetailArrayOfListIndustry ListIndustry
        {
            get
            {
                ...
                {
                    this.fListIndustry = new IIS.ISS35.DetailArrayOfListIndustry(this);
                }
                IIS.ISS35.DetailArrayOfListIndustry result = this.fListIndustry;
        ...
        public virtual IIS.ISS35.DetailArrayOfListInv ListInv
        {
            get
            {
                ...
                {
                    this.fListInv = new IIS.ISS35.DetailArrayOfListInv(this);
                }
                IIS.ISS35.DetailArrayOfListInv result = this.fListInv;
        ...
        public virtual IIS.ISS35.DetailArrayOfListSize ListSize
        {
            get
            {
                ...
                {
                    this.fListSize = new IIS.ISS35.DetailArrayOfListSize(this);
                }
                IIS.ISS35.DetailArrayOfListSize result = this.fListSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View SupportE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportE", typeof(IIS.ISS35.Support));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SupportL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportL", typeof(IIS.ISS35.Support));
                }
            }
        }
    }
